...
#---------- Fila 3 de botones ---------- #
btn1 = Button(FrameConte, text="1", width=3, command=lambda:numeroPulsado("7"))
btn1.grid(row=4, column=1)
btn2 = Button(FrameConte, text="2", width=3, command=lambda:numeroPulsado("8"))
btn2.grid(row=4, column=2)
btn3 = Button(FrameConte, text="3", width=3, command=lambda:numeroPulsado("9"))
